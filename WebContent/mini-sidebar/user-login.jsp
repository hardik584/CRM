                   ...
                   <%--  <form name="UserMasterVo" action="<%=request.getContextPath()%>/UserMasterController"  class="form-horizontal form-material" id="loginform" > --%>
                       ...
                       <p align="center">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input onkeyup="blank()" name="userEmail" id="userEmail" class="form-control" type="text" required="" placeholder="E-Mail"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input onkeyup="blank()" name="userPassword" id="userPassword" class="form-control" type="password"  placeholder="Password"> </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12 font-14">
                                ...
                                </div> <b><a href="user-recover-password.jsp" class="pull-right"> Forgot pwd?</a></b></div>
                        </div>
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <div>Don't have an account? <a href="user-register.jsp" class="text-info m-l-5"><b>Sign Up</b></a><br><a href="javascript:void(0)" onclick="tryLogin()">Try Demo</a></div>
